...
import ru.vorobev.spring.market.core.services.PayPalService;
...
public class PayPalController {
    ...
    public ResponseEntity<?> captureOrder(@PathVariable String payPalId) throws IOException {
        ...
        if ("COMPLETED".equals(payPalOrder.status())) {
            ...
            // Optional<ru.vorobev.spring.market.core.entities.Order> orderOptional = orderService.findById(orderId);
